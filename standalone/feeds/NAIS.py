...
# ================= OPERATOR SETTINGS =================
SOURCE="NAIS"; SOURCE_ID=7
INPUT_MODE="TCP"; INPUT_FOLDER=r"./input/NAIS"; FILE_PATTERNS=["*.csv","*.txt","*.nmea","*.log"]
POLL_SECONDS=2; RUN_ONCE=False
TCP_HOST="127.0.0.1"; TCP_PORT=20001
OUTPUT_FOLDER=r"./output/NAIS"
...
logging.basicConfig(level=logging.INFO,format="%(asctime)s | %(levelname)s | NAIS | %(message)s")
