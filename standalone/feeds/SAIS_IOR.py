...
# ================= OPERATOR SETTINGS =================
SOURCE="SAIS_IOR"; SOURCE_ID=1
INPUT_MODE="FOLDER"; INPUT_FOLDER=r"./input/SAIS_IOR"; FILE_PATTERNS=["*.csv","*.txt","*.nmea","*.log"]
POLL_SECONDS=2; RUN_ONCE=False
TCP_HOST="127.0.0.1"; TCP_PORT=20001
OUTPUT_FOLDER=r"./output/SAIS_IOR"
...
logging.basicConfig(level=logging.INFO,format="%(asctime)s | %(levelname)s | SAIS_IOR | %(message)s")
