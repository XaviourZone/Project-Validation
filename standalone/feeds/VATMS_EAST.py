...
# ================= OPERATOR SETTINGS =================
SOURCE="VATMS_EAST"; SOURCE_ID=5
INPUT_MODE="TCP"; INPUT_FOLDER=r"./input/VATMS_EAST"; FILE_PATTERNS=["*.csv","*.txt","*.nmea","*.log"]
POLL_SECONDS=2; RUN_ONCE=False
TCP_HOST="127.0.0.1"; TCP_PORT=20001
OUTPUT_FOLDER=r"./output/VATMS_EAST"
...
logging.basicConfig(level=logging.INFO,format="%(asctime)s | %(levelname)s | VATMS_EAST | %(message)s")
